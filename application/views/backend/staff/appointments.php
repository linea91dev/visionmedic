        ...
        <div id="sticky_left">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters_date" method="POST" action="<?php echo base_url();?>staff/appointments">
                                <div class="form-group date-time-picker m-b-15">
                                    <div class="input-group date datepicker" id="DoctorPicker1" style="border:0px;">
                                        <input onchange="submit()" type="text" id="applyDate" name="date" autocomplete="off" style="font-weight: 500;padding: 20px;background: #dcdcdc;border-radius: 9px;" value="<?php if($filter) echo $apply; else echo date('d/m/Y');?>" class="form-control">
        ...
        <div class="row">
                                ...
                                <div class="alert alert-<?php echo $className;?>">
                                    ...
                                    <div class="pipeline-item">
                                        <div class="pi-body">
                                            ...
                                            <div class="pi-info">
                                                <div class="h6 pi-name alert-<?php echo $className;?>-text"><?php echo $this->accounts_model->get_full_name('patient', $appointment['patient_id']);?></div>
            ...
            <div class="col-sm-5" id="appointment_details">
                <div id="sticky_rigth">
                    ...
                    <span style="display:block;margin-top:10px;font-size:17px;font-family:'Poppins',sans-serif;text-align:center">Selecciona una cita para ver los detalles.</span>
                </div>
            </div>
        </div>
    </div>
