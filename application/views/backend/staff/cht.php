...
<html lang="es">
        ...
        <div class="recent-default dynemic-sidebar active">
          <div class="recent">
            <div class="theme-title">
              <div class="media">
                <div>
                    <a href="<?php echo base_url();?>staff/appointments/" style="font-size:35px"><i class="picons-thin-icon-thin-0132_arrow_back_left"></i></a> 
                  <h2>¡Hola <?php echo $this->accounts_model->getirstname('staff', $this->session->userdata('login_user_id'));?>!</h2>
                  ...
                  <div class="theme-tab">  
                    ...
                    <div class="tab-content" id="myTabContent1">
                      <div class="tab-pane fade show active" id="direct" role="tabpanel" aria-labelledby="direct-tab"> 
                        ...
                        <?php 
                            $cont=0;
                            $current_user = 'staff-' . $this->session->userdata('login_user_id');
                        ...
                        ?>
                        <a href="<?php echo base_url();?>staff/chat_messages/<?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->username;?>" style="text-decoration:none;">
                            <li data-to="blank">
                            <div class="chat-box">
                              <div class="profile <?php if($this->crud_model->check_online_status($user_to_show_type, $user_to_show_id) > 0):?>online<?php else:?>busy<?php endif;?>"><img class="bg-img" src="<?php echo $this->accounts_model->get_photo($user_to_show_type, $user_to_show_id);?>"/></div>
                              <div class="details">
                  ...
                  ?>
                    ...
                    <li>
                      <div class="contact-box">
                        ...
                        if($this->crud_model->check_online_status($type, $c['id']) > 0):?>online<?php else:?>busy<?php endif;?>"><img class="bg-img" src="<?php echo $this->accounts_model->get_photo($type, $c['id']);?>" alt="Avatar"/></div>
                        <div class="details">
                          <h5><?php echo $this->accounts_model->short_name($type, $c['id']);?></h5>
                          <h6><?php echo $c['phone'];?></h6>
                        </div>
                        <div class="contact-action">
                          <div class="icon-btn btn-outline-primary btn-sm button-effect" onclick="javascript:location.href='<?php echo base_url();?>staff/chat_messages/<?php echo $c['username']?>'"><i data-feather="message-square"></i></div>
  ...
  function executeExample(chat_id)
  {
    Swal.fire({
      ...
      location.href = "<?php echo base_url();?>staff/cht/delete/"+chat_id;
      }
    })
  }
</script>
