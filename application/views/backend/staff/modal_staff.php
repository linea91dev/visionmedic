	                        ...
	                        <div class="row">
		                            ...
		                            <div class="col-sm-3">
		                                <div class="form-group m-b-15">
		                                    ...
		                                    <input type="text" name="dpi" id="dpi" required="" value="<?php echo $row['dpi'];?>" onkeyup="validateDPI(this.value);" class="form-control">
		                            ...
		                            <div class="col-sm-4">
		                                <div class="form-group m-b-15">
		                                     <label for="simpleinput">Cargo<span style="color:red">*</span></label>
	                            ...
	                            <div class="col-sm-4">
		                            <div class="form-group">
		                                ...
		                                <div class="custom-control custom-radio">
		                                    <input type="radio" id="male1" name="gender" value="M" <?php if($row['gender'] == "M") echo "checked";?> class="custom-control-input">
    		                                <label class="custom-control-label" for="male1">Masculino</label>
		                                </div>
		                            <div class="custom-control custom-radio"> 
		                                    <input type="radio" id="female1" name="gender" value="F" <?php if($row['gender'] == "F") echo "checked";?> class="custom-control-input">
    		                                <label class="custom-control-label" for="female1">Femenino</label>
		                            </div>
		                            </div>
		                        </div>
		                        <div class="col-sm-12">
		                        ...
		                        <div class="col-sm-6">
		                                <div class="form-group m-b-15">
		                                    ...
		                                    <label class="labelx" for="apply"><input type="file" name="photo" class="inputx" id="apply" accept=".jpg, .png, .jpeg">Seleccionar</label>
