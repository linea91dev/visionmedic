...
?>
            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/patient_security/<?php echo base64_encode($details['patient_id']);?>/"><i class="side-icon picons-thin-icon-thin-0705_user_profile_security_password_permissions"></i> Contraseña y seguridad <span class="side-active"></span></a>
                        </li>
                        <li class="side-li">
    ...
    function remove_session()
    {
        Swal.fire({
            ...
            if (result.value) 
            {
                location.href = "<?php echo base_url();?>staff/doctors/remove_sessions_patient/<?php echo $patient_id;?>";
            }
        })
    }
