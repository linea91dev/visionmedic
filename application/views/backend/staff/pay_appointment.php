                ...
                <div class="order-box">
                    <div class="order-details-box">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:auto; text-align:left;overflow-y:hidden">
                            <a class="dropdown-item"  href="<?php echo base_url();?>staff/patient_profile/<?php echo base64_encode($details['patient_id']);?>">Perfil del paciente</a>
                            ...
                            <?php endif;?>
                            <a class="dropdown-item" href="<?php echo base_url();?>staff/sale_details/pdf/<?php echo $_id;?>/<?php echo $details['patient_id']?>">Descargar PDF</a>
                        </div>
                    </div>
                    </div>
                    <hr>
                    ...
                    <div class="order-items-table">
                        <form action="<?php echo base_url();?>staff/inventory/confirm_appointment" method="POST">
                ...
                <div class="order-box">
                    <div class="order-details-box">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:auto; text-align:left;overflow-y:hidden">
                            ...
                            <a class="dropdown-item" target="_blank"href="<?php echo base_url();?>staff/print_prescription_details/<?php echo $_id;?>">Imprimir receta</a>
                            <?php endif;?>
                            <a class="dropdown-item" target="_blank"href="<?php echo base_url();?>staff/print_receipt/<?php echo $_id;?>/<?php echo $details['appointment_id']?>">Imprimir recibo</a>
                            <?php if($prescription_id > 0):?>
                            <a class="dropdown-item" href="<?php echo base_url();?>staff/sale_details/pdf/<?php echo $_id;?>/<?php echo $details['patient_id']?>">Descargar PDF</a>
                            <?php endif;?>
                    ...
                    <div class="order-foot">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                             ...
                             <div class="col-sm-12" style="margin-top: 15px;">
                                <button type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url();?>staff/print_receipt/<?php echo $_id;?>/<?php echo $details['appointment_id']?>'">Imprimir recibo</button>
                             </div>
                        </div>
                        </div>
                    </div>
