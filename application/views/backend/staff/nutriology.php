                                                                ...
                                                                <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                                    ...
                                                                    <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                        <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                            ...
                                                                            value="<?php echo $this->db->get_where('nutritional_history', array(  'appointment_id' => $details['appointment_id']))->row()->weight; ?>" <?php endif;?> >
                                                                        </div>
                                                        ...
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    ...
                                                                    <?php  if ($details['status'] == 4):?> value="<?php    echo $this->db->get_where('nutritional_history', array(  'appointment_id' => $details['appointment_id'] ))->row()->water;?>" 
                                                                    <?php endif; ?>>
                                                                </div>
                                                                <div class="_vital-sign-data-unit_c5jvwj"></div>
                                                            </div>
                                                        ...
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    ...
                                                                    <?php    if ($details['status'] == 4):?> value="<?php  echo $this->db->get_where('nutritional_history', array(    'appointment_id' => $details['appointment_id']   ))->row()->grease;?>" 
                                                                    <?php   endif;?>>
                                                                </div>
                                                                <div class="_vital-sign-data-unit_c5jvwj"></div>
                                                            </div>
                                                        ...
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    ...
                                                                    <?php   if ($details['status'] == 4):?> value="<?php  echo $this->db->get_where('nutritional_history', array(     'appointment_id' => $details['appointment_id']  ))->row()->muscle;?>" 
                                                                    <?php   endif;?>>
                                                                </div>
                                                                <div class="_vital-sign-data-unit_c5jvwj"></div>
                                                            </div>
                                                        ...
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    ...
                                                                    <?php   if ($details['status'] == 4):?> value="<?php echo $this->db->get_where('nutritional_history', array(   'appointment_id' => $details['appointment_id']  ))->row()->waist;?>" 
                                                                    <?php endif;?>>
                                                                </div>
                                                                <div class="_vital-sign-data-unit_c5jvwj"></div>
                                                            </div>
                                                        ...
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    ...
                                                                    <?php  if ($details['status'] == 4):?> value="<?php  echo $this->db->get_where('nutritional_history', array(    'appointment_id' => $details['appointment_id'] ))->row()->abdomen;?>" 
                                                                    <?php  endif;?>>
                                                                </div>
                                                                <div class="_vital-sign-data-unit_c5jvwj"></div>
                                                            </div>
