    ...
    <div class="todo-app-w">
        <div class="todo-content">
            <h4 class="todo-content-header">
                <i class="batch-icon-arrow-right"></i><span>Historial médico - <?php echo $this->accounts_model->get_name('patient',$details['patient_id']);?></span>
            </h4>
        	<div class="row">
                <div class="col-sm-12">
                    <div class="alert alert-info">
                        <span class="alert-title"><i class="batch-icon-spam"></i> Historial del paciente.</span>
                        <span class="alert-content">En esta sección podrás llevar el control clínico de tu paciente como signos vitales, antecendentes médicos e historial de <span class="alert-lined"><a href="javascript:void(0);" style="color:#0044e9">medicamentos</a>.</span></span>
                    </div>  
                </div>
                <div class="col-sm-12">
                    <a href="<?php echo base_url();?>staff/patient_profile/<?php echo base64_encode($patient_id);?>" class="btn btn-info"><i class="picons-thin-icon-thin-0132_arrow_back_left"></i> Regresar</a><br><br>
                </div>
                <div class="col-sm-3">
                <div id="antecedentes">
                    <div class="card-widget">
					    ...
					    <?php
						    ...
						    <?php endif;  
						  	    ...
						  	    <center>Tienes desbilitado el módulo de signos vitales para habilitarlo <a href="<?php echo base_url();?>staff/forms/">pulsa aquí</a></center><br><br>
		...
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/solid.min.css" integrity="sha256-APTxfVyJgjHUS35EeuRpYs2tAbIQO7UF0nAV6krdYJ0=" crossorigin="anonymous" />
					...
					<div class="card-b">
					    <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_allergies/<?php echo $patient_id;?>');">
                            ...
                            <ul style="margin-top:-15px;margin-bottom:15px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);list-style:none">
        			            ...
        			            ?>
                                <li><i class="fas fa-check" style="color:#60d600;font-size:14px"></i> <?php echo $row['name'];?><a href="javascript:void(0):" onclick="delete_allergie('<?php echo $row['allergie_id'];?>')"><i style="float:right;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_pathological_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                    <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_no_pathological_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                    <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_record_family_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_psychiatric_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_vaccination_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
                        ...
                        <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_nutriological_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
					    ...
					    <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_gyneco_obstetric_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
					    ...
					    <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_perinatal_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
					    ...
					    <div class="col-sm-12">
                            <div class="ant-tile ant-tile-inlined">
                                <a class="ant-tile-box faded" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_postnatal_list/<?php echo $patient_id;?>');">
                                    <div class="pt-new-icon">
                                        <i class="os-icon picons-thin-icon-thin-0151_plus_add_new"></i>
                                    </div>
                                </a>
            ...
            <div id="medicamentos">
                <div class="card-widget">
					...
					<div class="card-b">
                        <span><input type="text" id="medicament" class="form-control" style="width:80%; float:left;"> <a style="float:right;" type="submit" href="javascript:void(0);" id="submit_btn" value="+" class="btn btn-warning">+</a></span>
					</div>
					<br><br><br>
...
<?php  endforeach; ?>
    ...
    <script>
        ...
        $(document).ready(function()
        {
            $("#submit_btn").click(function()
            {
                ...
                {
                    $.ajax({
                        url:"<?php echo base_url();?>staff/medication_history/create/",
                        type:'POST',
    ...
    <script>
            ...
            {
                $.ajax({
                    url: '<?php echo base_url();?>staff/update_medication_table/'+patient_id,
        ...
        function delete_element(element_id)
        {
            ...
            if (r == true) {
                $.ajax({
                    url: '<?php echo base_url();?>staff/medication_history/delete/'+element_id,
                    success: function(response)
                    {
                        update_table_medication(patient_id);
                    }
        ...
        function delete_allergie(allergie_id)
        {
            ...
            Swal.fire({
                ...
                if (result.value) 
                {
                 ...
                 $.ajax({
                    url: "<?php echo base_url();?>staff/patients/delete_allergie/"+allergie_id,
                    success: function(response)
                    {
                      location.reload();
                    }
