...
?>
    ...
    <div class="todo-app-w" style="background: #f9f9f9;">
        ...
        <div id="sticky">
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/doctor_profile/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;    font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> <?php if($owner == 1):?> Editar perfil <?php else:?> Ver perfil<?php endif;?> <span class="side-active"></span></a>
                        </li>
                        <li class="side-li">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="tasks-section">
                        <form action="<?php echo base_url();?>staff/doctors/update/<?php echo $details['admin_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12 ">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input style="border: 1px solid #198cff8f;" type="number" name="dpi" id="dpi" required="" value="<?php echo $details['dpi']?>" onkeyup="validateDPI(this.value);" class="form-control" <?php if($owner != 1):?> readonly="" <?php endif;?>>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group m-b-15">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input style="border: 1px solid #198cff8f;" type="file" name="signature" class="form-control"/>
                                    </div>
                                </div>
                                <?php endif;?>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-<?php if($owner == 1):?>4<?php else:?>6<?php endif;?>">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check" style="padding-left: 0px;padding-right:4px">
                                          <input checked="" class="radiobutton" type="radio" name="status" id="single1" value="0" <?php if($details['status'] == 0) echo "checked";?> <?php if($owner != 1):?> disabled="" <?php endif;?>><label class="radiobutton-label" for="single1">Soltero</label>
                                        </div>
                                        <div class="form-check" style="padding-left: 0px;">
                                          <input class="radiobutton" type="radio" name="status" id="radio4x" value="1" <?php if($details['status'] == 1) echo "checked";?> <?php if($owner != 1):?> disabled="" <?php endif;?>><label class="radiobutton-label" for="radio4x">Casado</label>
                                        </div>
                                    </div>
		                        </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check" style="padding-left: 0px;padding-right:4px">
                                          <input checked="" class="radiobutton" type="radio" name="owner" id="owner" value="1" <?php if($details['owner'] == 1) echo "checked";?> <?php if($owner != 1):?> readonly="" <?php endif;?>><label class="radiobutton-label" for="owner">Propietario</label>
                                        </div>
                                        <div class="form-check" style="padding-left: 0px;">
                                          <input class="radiobutton" type="radio" name="owner" id="doctor" value="0" <?php if($details['owner'] == 0) echo "checked";?> <?php if($owner != 1):?> readonly="" <?php endif;?>><label class="radiobutton-label" for="doctor">Doctor</label>
                                        </div>
                                    </div>
		                        </div>
                                </div>
