		                        ...
		                        <div class="form-group text-center">
		                           ...
		                           <div class="form-group m-b-15">
        		                           <label for="simpleinput">No. factura</label></label>
		                                    <div class="form-group">
 		                                    <input type="text" name="invoice_code" id="invoice_code" value="<?php echo $row['invoice_code'] ?>" class="form-control"  accept="image/*">
		                                </div>
		                            </div>
		                            </div>
		                            <div class="col-sm-6" id="fact21">
		                                <div class="form-group m-b-15">
		                                    ...
		                                    <input type="file" name="invoice_file"id="invoice_file"  class="form-control" value="<?php echo $row['invoice_file'] ?>">
		                                </div>
		                            </div>
		                            </div>
		                        </div>
