    ...
    <div class="todo-content" id="resumen">
        ...
        <div class="row">
            ...
            <div class="card-box">
                    ...
                    <a class="btn btn-info pull-right" style="margin-top: 16px;margin-right: 17px;" onclick="modal_lg('<?php echo base_url();?>modal/popup/new_treatment/<?php echo $patient_id;?>');" href="javascript:void(0);"><i class="side-icon picons-thin-icon-thin-0826_teeth_tooth_dental"></i> <span>Iniciar plan</span></a>
                <br><br>
                <center><br>
