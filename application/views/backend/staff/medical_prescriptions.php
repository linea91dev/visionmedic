            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li style="border-bottom: 1px solid #eee;padding-bottom: 15px;">
                            <a class="side-items active" href="<?php echo base_url();?>staff/medical_prescriptions/<?php echo base64_encode($details['patient_id']);?>/"><i class="side-icon picons-thin-icon-thin-0003_write_pencil_new_edit"></i> Recetas <span class="side-active"></span></a>
                        </li>
                        <li style="border-bottom: 1px solid #eee;padding-bottom: 15px;">
                        ...
                        <?php $n = 1; foreach($prescriptions->result_array() as $pres): ?>
                            <tr style="font-family:'Poppins';font-size:14px;">
                                ...
                                <td>
                                    ...
                                    <i onclick="window.open('<?php echo base_url();?>staff/print_prescription_details/<?php echo $pres['appointment_id'];?>', '_blank');" class="picons-thin-icon-thin-0333_printer" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Imprimir"></i>
                                    <i onclick="window.location.href='<?php echo base_url();?>staff/medical_prescriptions/pdf/<?php echo $pres['appointment_id'];?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:22px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Descargar"></i>
                                </td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
	...
	<script type="text/javascript">
        function send_email(patient_id)
        {
            Swal.fire({
                ...
                {
                   $.ajax({
                        url: "<?php echo base_url();?>staff/medical_prescriptions/send/"+patient_id,
