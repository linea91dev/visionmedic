        ...
        <div class="custom-scroll right-sidebar">           
          <div class="contact-profile">
            ...
            <ul>
              ...
              <li><h5><a href="<?php echo base_url() . 'staff/'.$user_type.'_profile/'.base64_encode($user_id); ?>"> <i data-feather="crosshair"></i>Ir al perfil</a></h5></li>
...
var  AjaxURL = '<?php echo base_url();?>'+'/staff/cht/send_message';
  ...
  function deleteChat(chat_id)
  {
    Swal.fire({
      ...
      location.href = "<?php echo base_url();?>staff/cht/delete_single/"+chat_id+"/<?php echo $username;?>";
      }
    })
  }
