    		    ...
    		    <div class="col-sm-3">
    		        <div class="profile-tile profile-tile-inlined">
    		            <div class="profile-tile-box">
    		                <div class="tile-controls">
                                <div class="tile-settings os-dropdown-trigger">
                                    ...
                                    <div class="os-dropdown">
                                        ...
                                        <ul>
                                            <li><a href="<?php echo base_url();?>staff/staff_profile/<?php echo base64_encode($row['staff_id']);?>/"><i class="picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span>Perfil</span></a></li>
    		                ...
    		                <div class="pt-avatar-w"><img alt="" src="<?php echo $this->accounts_model->get_photo('staff', $row['staff_id']);?>"></div>
    		                ...
    		                <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>staff/messages/<?php echo $row['username'];?>';">Mensaje</div>
    		            </div>
    		        </div>
    		    </div>
		    <?php endforeach;?>
