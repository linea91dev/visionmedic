		    ...
		    <div class="col-sm-12">
		        <div class="row">
		            ...
		            <div class="col-md-3 col-lg-12 col-xl-3">
		                <a class="element-box el-tablo centered trend-in-corner smaller" href="javascript:void(0);"  onclick="total_table()" style="cursor:pointer;">
                            <div class="label">
                                Total de productos
                            </div>
                            <div class="value">
			        ...
			        <div class="col-md-3 col-lg-12 col-xl-3">
			            <a class="element-box el-tablo centered trend-in-corner smaller" href="javascript:void(0);"  onclick="vencido_table()" style="cursor:pointer;">
                            <div class="label">
                                Productos vencidos
                            </div>
                            <div class="value">
			        ...
			        <div class="col-md-3 col-lg-12 col-xl-3">
			            <a class="element-box el-tablo centered trend-in-corner smaller" href="javascript:void(0);"  onclick="vencer_table()" style="cursor:pointer;">
                            <div class="label">
			        ...
			        <div class="col-md-3 col-lg-12 col-xl-3">
			            <a class="element-box el-tablo centered trend-in-corner smaller" href="javascript:void(0);"  onclick="agotado_table()" style="cursor:pointer;">
                            <div class="label">
                               Productos agotados
                            </div>
                            <div class="value">
