...
?>
            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <?php endif;?>
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/patient_appointments/<?php echo base64_encode($details['patient_id']);?>/"><i class="side-icon picons-thin-icon-thin-0021_calendar_month_day_planner"></i> Citas <span class="side-active"></span></a>
                        </li>
                        <li class="side-li">
    ...
    <script type="text/javascript" language="javascript" >  
        ...
        var dataTable = $('#user_data').DataTable({  
            ...
            "order":[],  
            "ajax":{  
                url:"<?php echo base_url() . 'staff/getTable/patient_appointments/'.$patient_id; ?>",  
                type:"POST"  
            },  
