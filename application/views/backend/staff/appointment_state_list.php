<ul class="tasks-list">
    ...
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="soon"){ echo 'checked'; } ?> name="type"  type="radio" class="custom-control-input" id="customCheck3" onclick="window.location.href='<?php echo base_url();?>staff/soon/';">
    ...
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="rescheduled"){ echo 'checked'; } ?> name="type"  type="radio" class="custom-control-input" id="customCheck4" onclick="window.location.href='<?php echo base_url();?>staff/rescheduled/';">
