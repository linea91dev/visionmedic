...
<body >
	...
	<?php $prescription_details = $this->db->get_where('prescription', array('prescription_id' => $appointment_id))->result_array();
    	...
    	<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    	    <div class="modal-body" style="background-color:#fff;border-radius:25px">
        		<div class="form-group">
    		        <div class="container">
        		        <div class="row">
    		                <input type="hidden" id="patient_id" value="<?php echo $appointment_id;?>"/>
                                ...
                                <div>
                                    <div class="_header_ztkcf7">
                                        ...
                                        <div class="_header-meta_ztkcf7">
                                            ...
                                            <p>Generado por: <b>Medesk</b></p>
                                            <p>Impreso por: <b><?php echo $this->accounts_model->short_name('admin',$this->session->userdata('login_user_id'));?></b></p>
                                    ...
                                    <div class="_body_ztkcf7">
                                        ...
                                        <div class="_body-person-info_ztkcf7">
                                            ...
                                            <div>Género: <b><?php echo $this->crud_model->get_gender('patient', $content['patient_id']);?></b></div>
                                        ...
                                        <div class="_body-signature_ztkcf7">
                                             <?php if($this->db->get_where('admin', array('admin_id' => $doctor_id))->row()->signature!=""){ ?>
                                             <img src="<?php echo base_url();?>public/uploads/doctor_signature/<?php echo $this->db->get_where('admin', array('admin_id' => $doctor_id))->row()->signature; ?>" alt="<?php echo $this->db->get_where('clinic', array('clinic_id' => $this->session->userdata('current_clinic')))->row()->name;?>" style="width:40%;"><br> 
                                            <?php }?>
                                    ...
                                    <div class="_footer_ztkcf7">
                                        ...
                                        <div class="_footer-app-branding_ztkcf7">
                                            <p data-autoid="footer-prescription-info">Receta electrónica generada con Medesk</p>
                                            <b>https://medesk.gt</b>
                                        </div>
                                    </div>
                                </div>
