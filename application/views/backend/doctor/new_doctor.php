        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-sm-12" style="float: none; margin: 0 auto;">
                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                    ...
                    <form action="<?php echo base_url();?>doctor/doctors/create" method="POST" enctype="multipart/form-data" id="doc_form">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="form-check" style="padding-left: 0px;padding-right: 8px;">
                                            <input checked="" class="radiobutton" type="radio" name="status" id="single1" checked value="0"><label class="radiobutton-label" for="single1">Soltero</label>
                                        </div>
                                        <div class="form-check" style="padding-left: 0px;">
                                            <input class="radiobutton" type="radio" name="status" id="maried1" value="1"><label class="radiobutton-label" for="maried1">Casado</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-check" style="padding-left: 0px;">
                                            <input class="radiobutton" type="radio" name="owner" id="doctor" value="0" checked><label class="radiobutton-label" for="doctor">Doctor</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
