                            ...
                            <div id="middle-wizard">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <?php
                                                ...
                                                $this->db->where_not_in('service_id',array(21,23));
                                            ...
                                            <?php 
                                                ...
                                                if($odonto == 1):
                                                $odonto_service = $this->db->get_where('service', array('service_id'=>23))->row();    
                                            ?>
                                            <div class="inputGroup">
                                                <input id="service-<?php echo $odonto_service->service_id;?>" value="<?php echo $odonto_service->service_id;?>" name="practice_id" type="radio" class="service_check" />
                                                <label class="l" onclick="selectServices(<?php echo $odonto_service->service_id;?>)" for="service-<?php echo $odonto_service->service_id;?>"><?php echo $odonto_service->name;?></label>
                                            </div>
                                            <?php endif;
                                                $teleconsulta = $this->db->get_where('clinic', array('clinic_id'=>$this->session->userdata('current_clinic')))->row()->teleconsulta;
                                                if($teleconsulta == 1):
                                                $teleconsulta_service = $this->db->get_where('service', array('service_id'=>21))->row();    
                                            ?>
                                            <div class="inputGroup">
                                                <input id="service-<?php echo $teleconsulta_service->service_id;?>" value="<?php echo $teleconsulta_service->service_id;?>" name="practice_id" type="radio" class="service_check" />
                                                <label class="l" onclick="selectServices(<?php echo $teleconsulta_service->service_id;?>)" for="service-<?php echo $teleconsulta_service->service_id;?>"><?php echo $teleconsulta_service->name;?></label>
                                            </div>
                                            <?php endif;?>
                                            <div class="inputGroup">
                                ...
                                <div class="submit step">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12" id="patient_treatment"></div>
                                    </div>
                                </div>
                            </div>
