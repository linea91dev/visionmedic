...
?>
    ...
    <script src="<?php echo base_url();?>public/assets/appointments/js/select2.min.js"></script>
    <div id="main-content">
                                    ...
                                    <div class="card-box"><br>
		                                ...
		                                <div class="form-group">
										    <select class="itemName form-control select2" style="width:100%" name="patient_id" onchange="update_table(this.value)">
                                                ...
                                                ?>
										        <option value="<?php echo $pat['patient_id'];?>"><?php echo $this->accounts_model->get_name_patient('patient', $pat['patient_id']);?></option>
										        <?php endforeach;?>
										    </select>
										</div>
	                                </div>
