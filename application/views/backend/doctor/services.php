		    ...
		    <div class="card-b">
		        <div class="container-fluid">
    			    <div class="alert alert-info">
            		    ...
            		    <span class="alert-content">Todos los servicios que agregues en esta sección serán visualizados al momento de crear una nueva <span class="alert-lined"><a href="<?php echo base_url();?>doctor/appointment/" style="color:#0044e9">cita</a>.</span></span>
    		        </div>  
		        </div>
		        <div class="row">
...
<script type="text/javascript">
        function delete_service(service_id)
        {
            Swal.fire({
                ...
                if (result.value) 
                {
                    location.href = "<?php echo base_url();?>doctor/services/delete/"+service_id;
                }
            })
        }
    </script>