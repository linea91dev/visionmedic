    ...
    <div id="main-content">
        <div class="card-widget">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo base_url();?>doctor/question_board/<?php echo $surv_id;?>/">Detalles</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo base_url();?>doctor/questions/<?php echo $surv_id;?>">Preguntas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo base_url();?>doctor/survey_results/<?php echo $surv_id;?>">Resultados</a>
                </li>
            </ul><br>
            ...
            <div class="content-box">
                <div class="card-h">
		            <h2 class="card-caption">  <a href="<?php echo base_url();?>doctor/questions/<?php echo $surv_id;?>"><i class="picons-thin-icon-thin-0159_arrow_back_left"></i></a>
