        ...
        <?php if($this->session->userdata('login_user_id') == 1):?>
            <div class="todo-sidebar-section">
                <h5 class="todo-sidebar-section-header">
                    <span>Seleccionar doctor</span><a class="todo-sidebar-section-toggle" href="#"><i
                            class="batch-icon-user-2"></i></a>
                </h5>
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form  method="POST" action="<?php echo base_url();?>doctor/appointments">
                                <select class="itemName form-control select2" required="" name="doctor_id"
                                    onchange="submit()">
                                    ...
                                    <option value="<?php echo $pat['admin_id'];?>"
                                        <?php if($pat['admin_id'] == $doctor_id) echo "selected";?>>
