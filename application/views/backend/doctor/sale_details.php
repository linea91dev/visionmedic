                ...
                <div class="order-box">
                    <div class="order-details-box">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:auto; text-align:left;overflow-y:hidden">
                            ...
                            <a class="dropdown-item" target="_blank"href="<?php echo base_url();?>doctor/print_receipt/<?php echo $details['appointment_id'];?>/<?php echo $details['patient_id'];?>">Imprimir recibo</a>
                            <?php if($prescription_id > 0):?>
                                <a class="dropdown-item" target="_blank"href="<?php echo base_url();?>doctor/print_prescription_details/<?php echo $details['appointment_id'];?>">Imprimir receta</a>
                            <?php endif;?>
                            <a class="dropdown-item" href="<?php echo base_url();?>doctor/sale_details/pdf/<?php echo $details['appointment_id'];?>/<?php echo $details['patient_id'];?>">Descargar PDF</a>
                            ...
                            <a class="dropdown-item" target="_blank"href="<?php echo base_url();?>doctor/print_receipt2/<?php echo $cart_id;?>/<?php echo $details['patient_id'];?>">Imprimir recibo</a>
                            <a class="dropdown-item" href="<?php echo base_url();?>doctor/sale_details/pdf2/<?php echo $cart_id;?>/<?php echo $details['patient_id'];?>">Descargar PDF</a>
