                    ...
                    <div>
                        <table style="width:100%">
                            <tbody >
                                ...
                                <td class="text-right">
                                    <strong><?php echo $currency.'. '.number_format($this->db->get_where('appointment', array('appointment_id' => $appointment_id))->row()->charges,'2','.',','); ?></strong>
                                </td>
                                </tr>    
                            </tbody>
                        </table>
        ...
        <table cellpadding="0" cellspacing="0"  style="width: 100%; text-align: left; margin-top:50px;">
            ...
            <tr>
                <td colspan="4" style="padding:10px;font-size: 17px;text-align:right;border:1px; border-top:1px solid black">
                    <b>TOTAL: </b>
                    <?php echo $currency.'. '.number_format($inf['total']+$this->db->get_where('appointment', array('appointment_id' => $appointment_id))->row()->charges,'2','.',',');?>
                </td>
            </tr>
            </tbody>
        </table>
