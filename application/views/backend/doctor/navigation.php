    <aside class="side-nav side-nav-small scroll" id="nav" <?php if(!$this->crud_model->checkMobile()):?> style="overflow-y: auto!important;" <?php endif;?>>
		...
		<ul class="side-nav-wrapper">
			...
			<li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Doctores">
				<a href="<?php echo base_url();?>doctor/doctors/" <?php if($page_name == 'new_doctor' || $page_name == 'doctors' || $page_name == 'doctor_profile' || $page_name == 'doctor_appointments'):?>class="currentPage"<?php endif;?>>
			...
			<li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Equipo">
				<a href="<?php echo base_url();?>doctor/staff/" <?php if($page_name == 'staff' || $page_name == 'staff_profile' || $page_name == 'staff_notifications' || $page_name == 'staff_security' || $page_name == 'staff_activity' || $page_name == 'staff_permissions'):?>class="currentPage"<?php endif;?>>
			...
			<li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Inventario">
				<a href="<?php echo base_url();?>doctor/inventory/" <?php if($page_name == 'new_sale'  || $page_name == 'inventory' || $page_name == 'categories' || $page_name == 'sales' || $page_name == 'sale_details'):?>class="currentPage"<?php endif;?>>
			...
			<li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Nueva cita" >
                <a style="font-size:15px;padding-left: 20px;text-align:center;" href="<?php echo base_url();?>doctor/appointment/">
