        ...
        <div class="row">
            <div class="col-sm-9" style="float: none; margin: 0 auto;">
                 <h4 class="todo-content-header">
                    <i class="batch-icon-arrow-right"></i><span>Permisos de usuario - <?php echo $this->accounts_model->get_name('staff',$details['staff_id']);?></span>
                </h4>
                <div class="alert alert-info">
                 ...
                 <div class="col-sm-12">
                    ...
                    <form action="<?php echo base_url();?>doctor/staff/update_staff_modules/<?php echo $details['staff_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
