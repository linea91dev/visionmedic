...
?>
            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li style="border-bottom: 1px solid #eee;padding-bottom: 15px;">
                            <a class="side-items active" href="<?php echo base_url();?>doctor/medical_prescriptions/<?php echo base64_encode($details['patient_id']);?>/"><i class="side-icon picons-thin-icon-thin-0003_write_pencil_new_edit"></i> Recetas <span class="side-active"></span></a>
                        </li>
                        <li style="border-bottom: 1px solid #eee;padding-bottom: 15px;">
    ...
    <div class="todo-content" style="margin-bottom:10%">
        <h4 class="todo-content-header">
            <i class="batch-icon-arrow-right"></i><span>Recetas médicas - <?php echo $this->accounts_model->get_name('patient',$details['patient_id']);?></span>
        </h4>
        <?php
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info">
                    ...
                    <span class="alert-content">Gestiona las recetas o prescripciones médicas que ordenaste a tu <span class="alert-lined"><a href="javascript:void(0);" style="color:#0044e9">paciente</a>.</span></span>
                </div>  
            </div>
            <div class="col-sm-12">
                        ...
                        <?php $n = 1; foreach($prescriptions->result_array() as $pres): ?>
                            <tr style="font-family:'Poppins';font-size:14px;">
                                ...
                                <td>
                                    ...
                                    <i onclick="window.open('<?php echo base_url();?>doctor/print_prescription_details/<?php echo $pres['appointment_id'];?>', '_blank');" class="picons-thin-icon-thin-0333_printer" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Imprimir"></i>
                                    <i onclick="window.location.href='<?php echo base_url();?>doctor/medical_prescriptions/pdf/<?php echo $pres['appointment_id'];?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:22px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Descargar"></i>
                                </td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
	...
	<script type="text/javascript">
        function send_email(patient_id)
        {
            Swal.fire({
                ...
                {
                   $.ajax({
                        url: "<?php echo base_url();?>doctor/medical_prescriptions/send/"+patient_id,
