<?php
    ...
    $morning_val = $this->db->get_where('clinic', array('clinic_id' => $clinic_id))->row()->morning;

    $x = round((float)$morning_val);
                                    ...
                                    <div class="pipeline-item">
                                        ...
                                        <div class="pi-foot">
                                            <div class="tags">
                                                ...
                                                <a class="tag" href="<?php echo base_url();?>doctor/messages/<?php echo $this->db->get_where('patient', array('patient_id'=> $appointment['patient_id']))->row()->username;?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Enviar mensaje"><i
