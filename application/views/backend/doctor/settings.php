<link rel="stylesheet" href="<?php echo base_url();?>public/assets/telinput/intlTelInput.css">
    ...
    <div id="main-content">
        <form id="target" action="<?php echo base_url();?>doctor/settings/apply" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
				        <div class="card-box">
		                    <div class="card-h">
		                    ...
		                    <div class="card-b">
		                        <div class="row">
		                            ...
		                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group" style="visibility:<?php   $sms = $this->db->get_where('clinic', array('clinic_id' => $this->session->userdata('current_clinic')))->row()->sms; echo  $sms == 1? 'visible':'hidden'; ?>">
