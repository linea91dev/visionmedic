...
( function ( $ ) {
    ...
    } else
	{
		...
		if ($("#sticky").length)
		{
			new StickySidebar('#sticky', {topSpacing: 20});
		}
	
		if ($("#antecedentes").length)
		{
			new StickySidebar('#antecedentes', {topSpacing: 70});
		}
	
	
		if ($("#medicamentos").length)
		{
			new StickySidebar('#medicamentos', {topSpacing: 70});
		}

		if ($("#sticky_rigth").length)
		{
			var sidebar = new StickySidebar('#sticky_rigth', {topSpacing: 20});
		}


		if ($("#sticky_left").length)
		{
			var sidebar = new StickySidebar('#sticky_left', {topSpacing: 20});
		}
