...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'Selecciona ' + (options.limit == 1 ? 'Archivo' : 'Archivos'); },
            feedback: function(options) { return 'Selecciona ' + (options.limit == 1 ? 'archivo' : 'archivos') + ' para subir'; },
            feedback2: function(options) { return options.length + ' ' + (options.length > 1 ? ' archivos fueron' : ' archivos eran') + ' seleccionados'; },
			confirm: 'Confirmar',
            cancel: 'Cancelar',
			name: 'Nombre',
			type: 'Tipo',
            ...
            download: 'Descargar',
            remove: 'Eliminar',
            drop: 'Arrastra los archivos acá para subir',
            paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> Pasting a file, click here to cancel.',
            removeConfirmation: 'Estás seguro que quieres eliminar esto?',
            errors: {
                filesLimit: 'Solo puedes subir ${limit} archivos.',
                filesType: 'Solo puedes subir archivos ${extensions}.',
                fileSize: '¡${name} es muy pesado! Por favor selecciona un archivo menor a ${fileMaxSize}MB.',
                filesSizeAll: '¡Los archivos están muy pesados! Por favor sube archivos menores a ${maxSize} MB.',
                fileName: 'Al archivo ${name} ya está seleccionado.',
                folderUpload: 'No estás habilitado para subir folders.'
            }
        }
	}
})(jQuery);